    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "var(--warm-white)" }}>
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          .admin-main { margin-left: 0 !important; padding: 20px 16px 100px !important; }
        }
        @keyframes fadeIn {
        ...
        @media (max-width: 767px) {
          .sd-pill.expanded { width: calc(100vw - 48px); max-width: 300px; }
        }
        ...
        .sd-action {
          ...
          animation: fadeIn 0.2s ease both; flex: 1; height: 100%;
        }
        ...
        .sd-close {
          ...
          display: flex; align-items: center; justify-content: center;
          padding: 0 16px 0 12px; height: 100%; flex-shrink: 0;
          border-radius: 0 9999px 9999px 0; transition: color 0.15s ease;
      ...
      {/* Main content */}
      <main className="admin-main" style={{ marginLeft: 220, flex: 1, padding: "32px 40px", minHeight: "100vh", paddingTop: "32px" }}>

        {/* Mobile top padding so content clears the topbar */}
        <div className="admin-topbar-spacer" style={{ height: 0 }} />
        <style>{`.admin-topbar ~ * .admin-main { padding-top: 70px; } @media(max-width:767px){.admin-main{padding-top:70px!important;}}`}</style>
