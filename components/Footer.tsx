  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        {/* TOP */}
        <div
          className="flex flex-col md:flex-row md:items-end justify-between gap-10 pb-14 border-b"
        ...
        >
                ...
                {SOCIALS.map(({ label, href, icon }) => (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ...
                      el.style.color = "#EDE8DF";
                      el.style.borderColor = "transparent";
                    }}
                    onMouseLeave={(e) => {
                      const el = e.currentTarget as HTMLAnchorElement;
                      el.style.backgroundColor = "#FFFFFF";
                      el.style.color = "rgba(43,43,43,0.55)";
                      el.style.borderColor = "rgba(43,43,43,0.12)";
                    }}
                  >
                    {icon}
                  </a>
          ...
          {/* CTA card */}
          <div
            className="rounded-3xl px-8 py-7 flex flex-col sm:flex-row sm:items-center justify-between gap-6 md:max-w-md w-full"
          ...
          >
            ...
            <div className="flex justify-center items-center w-full">
              <Link
                href="#"
                className="group inline-flex items-center gap-3 border-2 font-bold pl-5 pr-2 py-2 rounded-full transition-all duration-300 shrink-0"
                style={{
              ...
              >
                ...
                <div
                  className="p-2 rounded-full group-hover:rotate-45 transition-all duration-300 translate-x-1"
                  style={{ backgroundColor: "#C8391A", color: "#FFFFFF" }}
                >
        ...
        {/* MIDDLE */}
        <div
          className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-10 py-14 border-b"
          style={{ borderColor: "rgba(43,43,43,0.12)" }}
        >
          <div className="flex flex-col gap-4">
            <p
          ...
          <div className="flex flex-col gap-4">
            <p className="text-xs font-bold uppercase tracking-widest invisible">
              hidden
            </p>
            <ul className="flex flex-col gap-2.5">
