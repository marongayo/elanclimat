    ...
    <div className="w-full px-3 sm:px-5 md:px-8 py-4 bg-[#ffffff]">
      <div className="grid grid-cols-1 md:grid-cols-2 bg-[#141d14] rounded-3xl overflow-hidden shadow-xl">
        ...
        <div className="flex flex-col justify-between p-8 sm:p-12 md:p-16 min-h-100 md:min-h-125">
          {/* Top Tag */}
          <div>
            <span className="inline-block bg-[#242d24] text-[#a1ad9c] text-xs font-semibold tracking-widest px-4 py-1.5 uppercase rounded-full">
              Talk to Us
            </span>
          </div>
          ...
          {/* CTA Button */}
          <div>
            <button className="inline-flex rounded-full items-center gap-3 bg-white hover:bg-transparent border-2 border-white text-black hover:text-white font-bold pl-6 pr-2 py-2 transition-all duration-300 cursor-pointer group">
